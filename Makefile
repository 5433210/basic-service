...
format: tools.verify.golines tools.verify.goimports
	...
	@$(FIND) -type f -name '*.go' | $(XARGS) $(GOBIN)/goimports -w -local $(ROOT_PACKAGE)
	@$(FIND) -type f -name '*.go' | $(XARGS) $(GOBIN)/golines -w --max-len=120 --reformat-tags --shorten-comments --ignore-generated .
	@$(GO) mod edit -fmt
